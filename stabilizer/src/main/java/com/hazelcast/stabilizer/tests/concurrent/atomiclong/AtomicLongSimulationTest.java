...
public class AtomicLongSimulationTest {

    private final static ILogger log = Logger.getLogger(AtomicLongSimulationTest.class);
    ...
    public static void main(String[] args) throws Throwable {
        AtomicLongSimulationTest test = new AtomicLongSimulationTest();
